...
var DatatablesAndCRUDOperationServerSide = function() {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="javascript:void(0)" data-id=${row.id} data-groups-table-filter="delete_row" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    var handleSearchDatatable = function() {
        const filterSearch = document.querySelector('[data-group-table-filter="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-groups-table-filter="delete_row"]');
    ...
    var initToggleToolbar = function() {
        ...
        const container = document.querySelector('#groups-datatable');
